...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<Pessoa> pessoas = new ArrayList<Pessoa>();
			...
			Estudante estudante01 = new Estudante("Barbara", "Cabo de Sº Agostinho");
			estudante01.addCursoNota("Historia", 7);
			estudante01.addCursoNota("Portugues", 9);
			
			Estudante estudante02 = new Estudante("Ligia", "Recife");
			estudante02.addCursoNota("Historia", 10);
			estudante02.addCursoNota("Matematica", 6);
			estudante02.addCursoNota("Portugues", 9);
			
			Estudante estudante03 = new Estudante("Luma", "Olinda");
			estudante03.addCursoNota("Historia", 6);
			estudante03.addCursoNota("Matematica", 5);
			estudante03.addCursoNota("Portugues", 10);
